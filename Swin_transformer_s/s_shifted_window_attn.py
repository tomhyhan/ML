...
class ShiftedWindowAttention(nn.Module):
    ...
    def define_relative_position_bias_table(self):
        ...
        nn.init.trunc_normal_(self.relative_position_biase_table, std=0.02)
    ...
    def define_relative_position_index(self):
        ...
        self.register_buffer("relative_coords_index", relative_position_index)
...
def _get_relative_position_bias(
    ...
    relative_position_bias = relative_position_bias.premute(2,0,1).contiguous().unsqueeze(0)
...
def shifted_window_attention(
    ...
    x = torch.pad(input, (0,0,0,pad_r,0,pad_b))
